    ...
    <head>
        ...
        <style>
            ...
            .imgSombra{
                ...
                margin: 0 auto;
                width: 50%
                -webkit-box-shadow: 14px 17px 31px 0px rgba(0,0,0,0.75);
                -moz-box-shadow: 14px 17px 31px 0px rgba(0,0,0,0.75);
                box-shadow: 14px 17px 31px 0px rgba(0,0,0,0.75)
            }
            .text-grande{
                font-size: 20px;
                font-weight:bold;
        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    ...
                    @else
                        <a href="{{ route('login') }}" class="text-sm text-gray-700 dark:text-gray-500 underline text-grande">Log in</a>
